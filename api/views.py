...
class FileUploadView(APIView):
    ...
    def merge_hdr_as_subprocess(self, MEDIA_PATH, bright_path, dark_path, exr_path, final_jpg_path, normal_path,
                                tonemapped_hdr_path):
        import subprocess
        hdr_create_command = "hdr_create -s 4 -o " + exr_path + " " + os.path.join(MEDIA_PATH,
                dark_path) + " " + os.path.join(MEDIA_PATH, normal_path) + " " + os.path.join(MEDIA_PATH, bright_path)
        hdr_tonemap_command = "hdr_squish -i " + exr_path + " -o " + tonemapped_hdr_path
    ...
    def post(self, request, format=None):
        ...
        self.merge_hdr_as_subprocess(MEDIA_PATH, bright_path, dark_path, exr_path, final_jpg_path, normal_path, tonemapped_hdr_path)
